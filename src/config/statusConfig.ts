...
export const HR_STATUS_OPTIONS: StatusOption[] = [
  ...
  { value: "reserve",  label: "Полиграф",            dot: "#f4a261", bg: "rgba(244,162,97,0.14)", fg: "#f4a261" },
  ...
  { value: "canceled", label: "Отказался кандидат",  dot: "#95a5a6", bg: "rgba(149,165,166,0.18)", fg: "#95a5a6" },
];