...
import DeleteEmployeeCell from "src/tables/cells/DeleteEmployeeCell";
...
const employeesColumns: GridColDef[] = [
...

  {
    ...
    sortable: false,
    renderCell: (p) => (
      <DepartmentCell row={p.row as any} value={p.value as any} patchKind="employee" />
    ),
  },
  {
    field: "position",
    ...
    sortable: false,
    renderCell: (p) => (
      <PositionCell row={p.row as any} value={p.value as any} patchKind="employee" />
    ),
  },
  {
    field: "hiredAt",
